...
public class LinkbaseInfoPrinter {
    ...
    public record ExtendedLink(String xlinkRole, ImmutableList<Arc> arcs,
                               ImmutableList<Locator> locators) implements XLink {
        public XLinkType xlinkType() {
            return XLinkType.EXTENDED;
        }
    }

    public record Linkbase(ImmutableList<ExtendedLink> extendedLinks) {
    }

    public ImmutableList<ExtendedLink> findAllExtendedLinks(ElemNode linkbaseElem) {
    ...
    private ImmutableList<Arc> findAllArcs(ElemNode extendedLinkElem) {
        assert hasAttributeValue(extendedLinkElem, xlinkTypeName, "extended");
    ...
    private ImmutableList<Locator> findAllLocators(ElemNode extendedLinkElem) {
        assert hasAttributeValue(extendedLinkElem, xlinkTypeName, "extended");
