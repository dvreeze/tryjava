...
public interface Node<N extends Node<N>> {
    ...
    Seq<N> findAllChildren();

    Seq<N> filterChildren(Predicate<N> predicate);

    Optional<N> findChild(Predicate<N> predicate);

    Seq<N> findAllDescendantsOrSelf();

    Seq<N> filterDescendantsOrSelf(Predicate<N> predicate);

    Optional<N> findDescendantOrSelf(Predicate<N> predicate);

    Seq<N> findAllDescendants();

    Seq<N> filterDescendants(Predicate<N> predicate);

    Optional<N> findDescendant(Predicate<N> predicate);

    Seq<N> findTopmostDescendantsOrSelf(Predicate<N> predicate);

    Optional<N> findTopmostDescendantOrSelf(Predicate<N> predicate);

    Seq<N> findTopmostDescendants(Predicate<N> predicate);
